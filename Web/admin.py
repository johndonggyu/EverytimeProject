...
from .models import board, Eval, lecture_evaluation, board_keyword, professor_keyword, major_keyword, lecture_time, smu_professor, search_major, major_synonym, colleges, majors, major_ngram_keyword
...
class EvalAdmin(admin.ModelAdmin):
	...
	search_fields = ['comment_prof__professor__professor__professor','comment_prof__professor__professor__major', 'comment']
...
class lectevalAdmin(admin.ModelAdmin):
	...
	search_fields = ['professor__professor__professor','score','assignment','team_project','credit','attendance','test','professor__lecture']
...
class smProfAdmin(admin.ModelAdmin):
	...
	list_filter = ['major']
	search_fields = ['major','professor','information']
...
class mkngAdmin(admin.ModelAdmin):
	list_display = ['major','keyword','word_date','count','pos_percent','neg_percent']
	list_display_links = ['major','keyword']
	list_filter = ['major','word_date','count']
	search_fields = ['major','keyword','pos_percent','neg_percent']
admin.site.register(major_ngram_keyword,mkngAdmin)
...
class lectimeAdmin(admin.ModelAdmin):
	search_fields = ['lecture','professor__professor','professor__major']
...
class majorsAdmin(admin.ModelAdmin):
	...
	list_filter = ['college']
	search_fields = ['major','college__college']
